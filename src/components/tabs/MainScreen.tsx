...
const cardImages: Record<Exclude<TabName, "profiles" | "main">, string> = {
  Skills: "images/skills.webp",
  Projects: "images/projects.webp",
  "Contact Me": "images/contact.webp",
...
const topPicks: Record<UserRole, Destination[]> = {
  ...
  developer: ["Projects", "Skills", "Contact Me"],
...
/* outlined numerals for the ranked row, sized from each glyph's real bounds */
const rankNumerals = [
  {
    viewBox: "0 0 74 154",
    ...
    <div className="main-wrapper" ref={mainWrapperRef}>
        ...
        <div className="main-info-wrapper">
          ...
          <div className="main-two-buttons">
            <a
              ...
              target="blank"
            >
              <svg className="play-icon" viewBox="0 0 30 30" aria-hidden="true">
                <path
      ...
      <div className="sections">
        <section className="row">
          <h2 className="row-title">Top Picks for {displayName}</h2>
          <div className="row-list">{renderCards(topPicks[user])}</div>
        </section>
        ...
        <section className="row">
          <h2 className="row-title">Top 5 Sections</h2>
          <div className="top-5-list">
            {topFive.map((destination, index) => (
              <div className="rank-entry" key={destination}>
                <svg
                  className="rank-number"
                  viewBox={rankNumerals[index].viewBox}
