...
const navItems: { label: string; tab: TabName }[] = [
  { label: "Home", tab: "main" },
  { label: "Skills", tab: "Skills" },
  { label: "Projects", tab: "Projects" },
  { label: "About", tab: "About" },
  { label: "Contact", tab: "Contact Me" },
];

const avatars: Record<UserRole, string> = {
  recruiter: "images/bluishavatar.webp",
  developer: "images/greenavatar.webp",
  writer: "images/redavatar.webp",
};
    ...
    <nav className={sectionClass}>
      ...
      <div className="right-navbar">
        <div className="contact-logos">
          <a
            href="https://github.com/AdamMeddah"
            target="_blank"
        ...
        >
          <img src={user ? avatars[user] : avatars.recruiter} alt="" />
        </button>
